...
**Version:** 1.0  
**Module:** Core Cryptography & Circuit Builder (Person 4)
...
1. **Extract Keys:** The enc_key and enc_iv are decrypted using the Relay's RSA Private Key.
2. **Decrypt Payload:** The enc_payload is decrypted using the extracted AES key/IV.
3. **Parse Result:** The decrypted bytes form a JSON object containing routing instructions.
