...
- To target a remote directory server use `--directory` or set `MATRYOSHKA_DIRECTORY_URL`.

Example (use your VPS directory):

```bash
python cli/client.py --directory http://194.146.36.166:5000/relays --message "Hello" --dest 194.146.36.166:8001
```
